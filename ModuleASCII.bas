...
End Sub
Public Sub CleanBlitAsc()
    SDC = frmBack.PicASCHorizontalClean.hDC
    DDC = frmBack.PicASCHorizontalWork.hDC
    BitBlt DDC, 0, 0, frmBack.PicASCHorizontalWork.Width, frmBack.PicASCHorizontalWork.Height, SDC, 0, 0, SRCCOPY
End Sub
